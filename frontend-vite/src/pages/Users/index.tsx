  ...
  return (
    <PageWrapper>
      <div className="d-flex justify-content-between align-items-center mb-4">
        ...
        <button className="btn btn-wa-primary" onClick={() => setShowModal(true)} aria-label="Invite new platform user">
      ...
      <Modal show={showModal} onHide={() => setShowModal(false)} centered>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <Modal.Footer>
            ...
            <Button type="submit" className="btn-wa-primary" disabled={createMutation.isPending}>{createMutation.isPending ? 'Saving...' : 'Invite User'}</Button>
          </Modal.Footer>
        </Form>
      </Modal>
    </PageWrapper>
